...
cmdlnparser.add_argument('-s', '--sentimentpickle', help="pickle file containing dictionary mapping each user-product tuple to its sentiment score (output)", default="pklsentiments.pkl")

...
cmdlnparser.add_argument('-d', '--data', help="data file containing Amazon review data (input", default="reviews_Amazon_Instant_Video_5.json.gz")
cmdlnparser.add_argument('-p', '--productpickle', help="pickle file containing dictionary mapping each product to its reviews (output)", default="products.pkl")
cmdlnparser.add_argument('-u', '--userpickle', help="pickle file containing dictionary mapping each user to his or her reviews (output)", default="users.pkl")
cmdlnparser.add_argument('-s', '--sentimentpickle', help="pickle file containing dictionary mapping each user-product tuple to its sentiment score (output)", default="sentiments.pkl")
